...
#ifndef __LIPNET_NETWORK_PROBLEM_BATCH_HPP__
#define __LIPNET_NETWORK_PROBLEM_BATCH_HPP__
...
namespace lipnet {
    ...
    /**
     * @brief The network_problem_batch_t struct. The problem implementation of nominal neural
    ...
    struct network_problem_batch_t :
            public backpropagation_batch_t<T, ATYPE, LOSS, BATCH, N...>,
            public problem_t< T, problem_type::NONLINEAR, network_problem_batch_t<T,ATYPE,LOSS,N...>,
        ...
        using self_back_t::backpropagation_batch_t;
...
#endif // __LIPNET_NETWORK_PROBLEM_BATCH_HPP__
